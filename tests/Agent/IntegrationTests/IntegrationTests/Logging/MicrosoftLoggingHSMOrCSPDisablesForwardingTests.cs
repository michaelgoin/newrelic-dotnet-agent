...
namespace NewRelic.Agent.IntegrationTests.Logging
{
    ...
    [NetFrameworkTest]
    public class MicrosoftLoggingHSMDisablesForwardingTestsFWLatestTests : MicrosoftLoggingHSMOrCSPDisablesForwardingTestsBase<ConsoleDynamicMethodFixtureFWLatestHSM>
    {
        public MicrosoftLoggingHSMDisablesForwardingTestsFWLatestTests(ConsoleDynamicMethodFixtureFWLatestHSM fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
    }
    ...
    [NetFrameworkTest]
    public class MicrosoftLoggingCSPDisablesForwardingTestsFWLatestTests : MicrosoftLoggingHSMOrCSPDisablesForwardingTestsBase<ConsoleDynamicMethodFixtureFWLatestCSP>
    {
        public MicrosoftLoggingCSPDisablesForwardingTestsFWLatestTests(ConsoleDynamicMethodFixtureFWLatestCSP fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
    }
